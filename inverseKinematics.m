...
p_initial = [ (-1000.033 - -1000.116); 9.987; 814.333; 1];
...
Rx = (85.563*cosd(30)*cos(q_2+q_3) + 85.563*sind(30)*sin(q_2+q_3)) * sin(q_4+q_2+q_3);
...
tic;
% Transformation matrices for angle effect of q_2+q_4 on joint4 and above
...
%%
%Copied from GIT before stuffing around is below
%% Forward component
% D1 = 197.13;%275.5;
% D2 = 410;
% D3 = 207.3;
...
% 
% % px = P_next(1); py = P_next(2); pz = P_next(3);
% px = p_initial(1);
% py = p_initial(2);
% pz = p_initial(3);
% 
...
% 
% 
% %P = A_up * [0;0;0;1]; peter corke's toolbox has ready config qr = [3*pi/2
% %pi pi 0 0 0]
