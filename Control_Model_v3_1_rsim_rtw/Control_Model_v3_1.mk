...
MODEL               = Control_Model_v3_1
MODULES             = Control_Model_v3_1_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c 
MAKEFILE            = Control_Model_v3_1.mk
...
MASTER_ANCHOR_DIR   = 
START_DIR           = C:/Users/Callum/Documents/2017/METR4901
S_FUNCTIONS         = 
S_FUNCTIONS_LIB     = 
...
MODELLIB                  = Control_Model_v3_1lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Control_Model_v3_1_ref.rsp
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	-I$(START_DIR)/Control_Model_v3_1_rsim_rtw \
	-I$(START_DIR) \
...
ifeq ($(MODELREF_TARGET_TYPE), NONE)
    ...
    REQ_SRCS           = $(MODEL).c $(MODULES) $(EXT_SRC) \
                         rsim_main.c rsim_sup.c rsim_mat.c rapid_utils.c simulink_solver_api.c
...
$(PRODUCT) : $(OBJS) $(SHARED_LIB) $(LIBS) $(MODELREF_LINK_LIBS)
	$(BIN_SETTING) $(LINK_OBJS) @$(MODELREF_LINK_RSPFILE) $(SHARED_LIB_LINK) \
		$(LIBS) $(MAT_LIBS) $(MATLAB_ROOT)\sys\lcc64\lcc64\lib64\ws2_32.lib $(MATLAB_ROOT)\sys\lcc64\lcc64\lib64\mswsock.lib $(MATLAB_ROOT)\sys\lcc64\lcc64\lib64\advapi32.lib
