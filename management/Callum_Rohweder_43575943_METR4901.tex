...
%% this should be compared to how VREP controls the arm using PID in the theory section. Additionally, the advantage of calculating the dynamic equation for the arm for LQR <<<< nooooooo dont use this
...
%http://wiki.ros.org/ROS/Introduction %\cite{ROSTech}
%https://github.com/Kinovarobotics/kinova-ros	%\cite{kinova-ros}
...
% need to discuss at some stage that communication isn't guaranteed between different networks, i.e. home verse uni<< done
...
\bibliography{Callum_Rohweder_43575943_METR4901}{}
...
\begin{sidewaysfigure}[htb]
  \includegraphics[width=1\linewidth]{client_flow_pt1.jpg}
\caption{Simplified Client Software Diagram Pt1}
\label{fig:PropProf}
\end{sidewaysfigure}

\begin{sidewaysfigure}[htb]
  \includegraphics[width=1\linewidth]{client_flow_pt2.jpg}
\caption{Simplified Client Software Diagram Pt2}
\label{fig:PropProf}
\end{sidewaysfigure}
